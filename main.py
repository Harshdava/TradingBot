...
async def journal_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not trades:
        ...
        for doc in trades:
            report += f"[{doc['timestamp'][:16]}] {doc['content']}\n"
    ...
    await update.message.reply_document(document=file_bytes, caption=f"📊 Net P&L: ₹{net}")
